...
<hr class="hr">
<div align="center">
 <a href="http://icljk.com/m/index.php">
<img align="center" src="/m/buttons/HOME-HOME.png" width="60%" height="40" alt="STUDENT" ></a>
</div>


    <div class="marquee-with-dr" align="center"><h7></h7>ENTER YOUR REGD NO. AND PASSWORD ***.</h7></div>


 

<div class="form-popup" id="myForm">
 <form action="/m/st_search.php" class="form-container" method="post">
     <h1 cclass="btn cancel" align="center">Student Login</h1>
