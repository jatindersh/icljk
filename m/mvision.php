...
<div class="button" align="justify" style="left-margin=1% ; right-margin=1%;">
    <p align="center">
          ...
          <a href="https://icljk.com/m/mcourses.php"><button class="button button2">Courses</button></a></p>
           <p >
              <img src="/m/images/vm.png" style="width:100%">
            VISION:--<br/>

ICL COMPUTER Education seeks to create academic excellence which is scientifically immaculate, culturally, superb and aesthetically par excellence in all totality. Enormously desirous to serve society by preparing the teacher of great order qualitatively with collective and honest effort both in conventional and non-conventional courses so that field is replete with exquisitely good character.<br/>
MISSION:--<br/>

ICL COMPUTER Education fosters in pupil teachers social integrity, cultural independence and scientific development. ICL Education endures to create supportive and diverse community in all aspects to prepare pupil teacher for development of the ultimate and understanding of the self. others and the community. To these ends college strives for the development of pupil teachers in scientific knowledge, philosophical skills and cultural values and global awareness necessary to pursue career to achieve sublime leaders</p>
